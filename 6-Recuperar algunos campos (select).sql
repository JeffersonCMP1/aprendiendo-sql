--TEMA DE HOY-RECUPERAR ALGUNOS CAMPOS CON SELECT

--borramos la tabla de libros si ya existe
...
insert into libros(titulo, autor,editorial, precio, cantidad)values('El Alpeh','Borges', 'Emece', 25.50, 100);
insert into libros(titulo, autor,editorial, precio, cantidad)values('Alicia en el pais','Lewis Carol', 'Atlantida', 10, 200);
insert into libros(titulo, autor,editorial, precio, cantidad)values('Matematica estas ahi','Paenza', 'Siglo XXI', 18.8, 200);


--recuperamos todo los datos de los libros
select*from libros;
