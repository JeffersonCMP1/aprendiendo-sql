...
insert into empleados(nombre,documento,sexo, domicilio,sueldobasico)
values('Juan Juarez','12345678','M','123',500),
('Ana acosta','2789999','F','colon 134',700),
('Carlos Caseres','31222333','m','Urquiza 479',850);

select*from empleados;  --5- Muestre todos los datos de los empleados

select nombre, documento, domicilio from empleados --6- Muestre el nombre, documento y domicilio de los empleados
